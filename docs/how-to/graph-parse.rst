...
There is no need to explicitly define a distance matrix. The parsing would include three functions from the :ref:`Source <https://cspath.readthedocs.io/en/latest/reference/source.html>`.
